...
try:
    ...
    import json, numpy, os, re, time
except ImportError as e:
    prRed(f'src/intersight/system_software_repository.py - !!! ERROR !!!\n{e.__class__.__name__}')
    ...
    def os_install(self, kwargs):
        ...
        for x in range(0,len(server_profiles)):
            ...
            if kwargs.imm_dict.orgs[kwargs.org].wizard.server_profiles[x].boot_volume.lower() == 'm2':
                ...
                if m2_found == False:
                    ...
                    pcolor.Red(f'  Exiting... (intersight-tools/new/src/intersight/core.py Line 1448)')
                    pcolor.Red(f'\n{"-"*108}\n')
        ...
        for x in range(0,len(kwargs.imm_dict.orgs[kwargs.org].wizard.server_profiles)):
            ...
            if v.os_installed == False:
                ...
                if kwargs.args.repository_check_skip == False: shared_functions.test_repository_url(url)
                #=============================================================
                ...
                # POST OS Install
                #=============================================================
                kwargs = kwargs | DotMap(api_body = shared_functions.installation_body(v, kwargs), method = 'post', uri = 'os/Installs')
        ...
        if os_install_fail_count > 0:
            ...
            pcolor.Red(f'\n{"-"*108}\n')
            pcolor.Red(f'  Exiting... (intersight-tools/new/src/intersight/core.py Line 1576)'); len(False); sys.exit(1)
        return kwargs
